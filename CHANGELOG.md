...
- Bump Native SDK from v0.7.17 to v0.8.1 ([#16](https://github.com/CEksal/sentry-dart/pull/16))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#081)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.7.17...0.8.1)
